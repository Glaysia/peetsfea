...
## Current contract
- Version: `0.3.5`
- Design-space SSOT: package data `src/peetsfea/data/0.3.5_sweep.toml` (`DEFAULT_REFERENCE_TOML_PATH`).
  The canonical fixed point is `src/peetsfea/data/0.3.5_fixed.toml` (`DEFAULT_SOURCE_TOML_PATH`).
...
../.venv/bin/python ../entry/view.py --fixed   # build/view data/0.3.5_fixed.toml
```
...
- `peetsfea.__version__ == "0.3.5"`, ships `py.typed`.
