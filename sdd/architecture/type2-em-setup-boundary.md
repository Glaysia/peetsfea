...
- Keep geometry-only `tx_outer_single_coil`, including passive outer void-stack and bottom-underlay bodies, import/styling separate from active EM setup inputs.
...
- Passive outer void-stack and bottom-underlay scope is owned by [0.2.24 Type2 TX Outer Void Stack](../plans/0.2.24-type2-tx-outer-void-stack.md).
