...
- TX outer companion, passive outer void-stack clipping, and passive outer bottom-underlay role details are active plan-owned extensions. The current implementation must follow [0.2.24 Type2 TX Outer Single Coil](../plans/0.2.24-type2-tx-outer-single-coil.md) and [0.2.24 Type2 TX Outer Void Stack](../plans/0.2.24-type2-tx-outer-void-stack.md) without changing reusable rect-void core ownership.
