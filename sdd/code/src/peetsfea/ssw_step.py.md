...
- Responsibility: parse the 0.3.0 fixed SSW TOML surface and constraints, place coilmaker TX/RX coil assemblies and MULL ferrite sheets in the TV scene, and generate CadQuery STEP geometry, action-token TOML, and a JSON ledger.
