...
- plate-stack ferrite group members use exact exported ferrite-family names in `expected_exported_body_names` order; TX arrays may have multiple branch-local PET/PSA, ferrite, and air bodies.
