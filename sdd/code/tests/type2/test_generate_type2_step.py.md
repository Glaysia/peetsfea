...
- Fixed examples must verify fixed non-modeled `tx_region` X/Y width `720.0 x 1200.0` centered at Y=0, fixed `x_ratio=0.99`, preserved `y_usage_ratio`, selected 0.2.21 TX/RX outer-size ratios, and fixed TX/RX turn counts of 2 and 3.
