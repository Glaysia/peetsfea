...
- Focused pure build123d/OCC contract tests for the Type2 single-coil ferrite/PET_PSA priority clearance helper.

## Inputs / Outputs
- Inputs: synthetic labeled build123d box solids and optional labeled ferrite group compounds.
- Outputs: assertions on returned ordered scene children, labels, solid counts, volumes, and zero FR4/ferrite positive-volume overlap after cutting.
