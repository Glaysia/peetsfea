...
- Fixture TOML uses active type2 schema v6 and includes fixed `tx_region_actual` and `tx_region_actual_pcb` non-model owners so this test can focus on TX plate-stack sampled owners.
