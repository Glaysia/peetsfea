...
- active example keeps RX single-coil as the only modeled object and adds sampled non-model `tx_region_actual` X/Y usage, X/Y division owners, and `tx_region_actual_pcb.scale_ratio`.
