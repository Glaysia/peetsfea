...
## Quick Checkpoints
- Input spec: `examples/legacy/type1.toml`
- Run entrypoint: `entry/legacy/type1/sample.py` -> `entry/legacy/type1/build.py`, or `entry/legacy/type1/sample_build.py` to replay pre-generated manifests in a GUI-visible debug session
