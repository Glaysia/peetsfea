...
## 빠른 확인 포인트
- 입력 스펙: `examples/legacy/type1.toml`
- 실행 진입점: `entry/legacy/type1/sample.py` -> `entry/legacy/type1/build.py`, 또는 미리 생성된 manifest를 GUI-visible replay로 확인하는 `entry/legacy/type1/sample_build.py`
