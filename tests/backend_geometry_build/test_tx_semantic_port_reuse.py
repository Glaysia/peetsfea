...
from peetsfea.backend.pyaedt.geometry.builders.build_excitation_ops import _create_tx_semantic_port_if_needed
from peetsfea.backend.pyaedt.geometry.build_state import TxSeriesBindingInputs
from peetsfea.backend.pyaedt.geometry.tx_stub_faces import (
