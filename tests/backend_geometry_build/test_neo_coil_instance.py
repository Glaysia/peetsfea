...
from peetsfea.backend.pyaedt.geometry.build_state import GeometryBuildState
from peetsfea.backend.pyaedt.geometry.builders.neo_coil_instance import NeoCoilBoxInstance, NeoCoilInstance
