...
def test_freeze_sampled_ranges_only_preserves_fixed_owners_and_non_sampled_content(
    ...
    resolved_tx_vertical = require_table(resolved_coil_shape["tx_vertical"], "coil_shape.tx_vertical")
    source_tx_vertical = require_table(source_coil_shape["tx_vertical"], "coil_shape.tx_vertical")
    resolved_outer_x = require_table(resolved_tx_vertical["outer_x"], "coil_shape.tx_vertical.outer_x")
    source_outer_x = require_table(source_tx_vertical["outer_x"], "coil_shape.tx_vertical.outer_x")
