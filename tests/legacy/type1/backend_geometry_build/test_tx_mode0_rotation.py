...
from peetsfea.legacy.type1.backend.pyaedt.geometry.rules.cad_probe import _probe_cad_object
from peetsfea.legacy.type1.backend.pyaedt.geometry.rules.tx_mode0_rotation import (
    compute_tx_mode0_rotation_angle_rad,
    rotate_tx_mode0_objects_if_needed,
)
from peetsfea.legacy.type1.backend.pyaedt.geometry.tx_stub_faces import capture_stub_face_ref_from_object, edge_id_from_face_id, edge_points_from_edge_id
