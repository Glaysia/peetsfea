...
import peetsfea.legacy.type1.backend.pyaedt.geometry.build as geometry_build_module
from peetsfea.legacy.type1.backend.pyaedt.geometry.build import _build_all_coils, _build_tx_ferrite, _finalize_geometry
