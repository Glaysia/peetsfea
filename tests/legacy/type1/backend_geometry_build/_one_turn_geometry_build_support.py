...
TEST_PEETSFEA_PACKAGE_ROOT = (Path(__file__).resolve().parents[4] / "src" / "peetsfea").resolve()
...
def _install_group_builder_tx_dd_test_alias() -> None:
    legacy_module_name = "peetsfea.legacy.type1.backend.pyaedt.geometry.builders.group_builder_tx_dd"
    ...
    if (builders_root / "group_builder_tx_dd.py").is_file():
        return
    backup_module_name = "peetsfea.legacy.type1.backend.pyaedt.geometry.builders.group_builder_tx_dd_wrapper_backup"
...
import peetsfea.legacy.type1.backend.pyaedt.geometry.builders.build_tx_vertical as build_tx_vertical_module
from peetsfea.legacy.type1.backend.pyaedt.geometry.rx_stub_ports import (
...
from peetsfea.legacy.type1.backend.pyaedt.geometry.builders.group_builder_rx_dd import build_for_board as build_rx_dd_for_board
from peetsfea.legacy.type1.backend.pyaedt.geometry.builders.group_builder_tx_dd import (
    build_for_board as build_tx_dd_for_board,
)
from peetsfea.legacy.type1.backend.pyaedt.geometry.builders.group_builder_tx_vertical import build_for_board as build_tx_vertical_for_board
...
from peetsfea.legacy.type1.backend.pyaedt.geometry.rules.solid_ops import safe_unite
from peetsfea.legacy.type1.backend.pyaedt.geometry.rules.spiral_points import _map_xy_points_to_yz, _mirror_points_about_y_axis_line
...
def test_finalize_solids_compacts_tx_vertical_zx_bridge_names_for_long_design_id() -> None:
    ...
    with patch(
        "peetsfea.legacy.type1.backend.pyaedt.geometry.builders.build_finalize_ops._close_stacked_tx_dd_half_conductors_with_hex_vias",
...
def test_finalize_solids_assigns_txdd_in_out_stub_roles_from_semantic_feed_bindings() -> None:
    ...
    with patch(
        "peetsfea.legacy.type1.backend.pyaedt.geometry.builders.finalize_stage_tx._create_tx_semantic_port_if_needed",
        autospec=True,
